...
# symbols sub-command
#parse_symb = subparsers.add_parser('symbols', help='get mouse symbol names')
#parse_symb.add_argument('--test', action='store_true')
#parse_symb.set_defaults(func=symbols)
